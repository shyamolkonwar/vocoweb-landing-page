      ...
      <header className="fixed top-0 left-0 right-0 flex items-center justify-between whitespace-nowrap border-b border-[#1C1E26] bg-[#060608]/80 backdrop-blur-md z-50 px-4 md:px-6 lg:px-12 py-3 md:py-4 h-14 md:h-16 max-w-[1440px] mx-auto w-full">
        ...
        <div className="hidden md:flex gap-3">
          <button
            ...
            className="min-w-[140px] flex items-center justify-center overflow-hidden rounded bg-[#C8D8F0] hover:bg-[#C8D8F0]/90 transition-colors text-[#060608] text-sm font-bold h-9 px-4 tracking-wide uppercase cursor-pointer"
          ...
          <div className="flex flex-col px-4 py-4 gap-0">
            ...
            <div className="flex flex-col gap-3 pt-4">
              <button
                ...
                className="w-full flex items-center justify-center overflow-hidden rounded bg-[#C8D8F0] hover:bg-[#C8D8F0]/90 transition-colors text-[#060608] text-sm font-bold h-10 px-4 tracking-wide uppercase cursor-pointer"
                style={{ fontFamily: "var(--font-geist-mono), monospace" }}
              >
                Join Waitlist
              </button>
